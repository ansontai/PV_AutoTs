...
# Compatibility: newer pytorch_lightning may not expose `utilities.distributed`.
try:
    if hasattr(pl, 'utilities') and hasattr(pl.utilities, 'distributed') and hasattr(pl.utilities.distributed, 'log'):
