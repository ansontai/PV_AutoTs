...
DEFAULT_FIT_FORECAST_LENGTH = 10
...
# DEFAULT_OUTPUT_TAG = Path(__file__).resolve().stem.replace('10vG1_Lancher-', '')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Launcher for 10vG1 365d forecast')
    ...
    child_script = script_dir / '10vG1_autots_365d_forecast.py'
