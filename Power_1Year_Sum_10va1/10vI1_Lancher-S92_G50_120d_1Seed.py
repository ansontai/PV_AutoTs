...
# DEFAULT_OUTPUT_TAG = Path(__file__).resolve().stem.replace('10vH1_Lancher-', '')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Launcher for 10vH1 365d forecast')
    ...
    child_script = script_dir / '10vH1_autots_365d_forecast.py'
