...
## 輸入 "raw" / "Timeseries_24.148_120.703_E5_0kWp_crystSi_25_35deg_1deg_2005_2005[P_scaled_hourly].csv"
## 輸出 Timeseries_24.148_120.703_E5_0kWp_crystSi_25_35deg_1deg_2005_2005[UTC+8][daily][scaled].csv

# 檔案路徑（相對於本檔案所在目錄）
HERE = Path(__file__).parent
DEFAULT_INPUT = HERE / "output" / "Timeseries_24.148_120.703_E5_0kWp_crystSi_25_35deg_1deg_2005_2005[P_scaled_hourly][vB].csv"
DEFAULT_INPUT_RAW = HERE / "raw" / "Timeseries_24.148_120.703_E5_0kWp_crystSi_25_35deg_1deg_2005_2005[P_scaled_hourly][vB].csv"
DEFAULT_OUTPUT = HERE / "output" / "Timeseries_24.148_120.703_E5_0kWp_crystSi_25_35deg_1deg_2005_2005[UTC+8][daily][scaled][vB].csv"
...
power_cols = [c for c in ['P', 'P_Wh_min_max_scaled', 'P_max_normalization', 'P_wh_max_scaled'] if c in df.columns]
for c in power_cols:
...
# 觀測數與有效比例
key_cols = [c for c in ['P','P_Wh_min_max_scaled','P_max_normalization','P_wh_max_scaled','G(i)','G(h)','T2m','RH','WS10m','WD10m','SP','H_sun'] if c in df.columns]
for c in key_cols:
