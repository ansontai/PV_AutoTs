...
Input:
  tmy_24.148_120.703_2005_2023[UTC+8][daily][mapped].csv
...
DEFAULT_INPUT_NAME = "tmy_24.148_120.703_2005_2023[UTC+8][daily][mapped].csv"
...
def find_input_file(explicit_path: Path | None = None) -> Path:
	...
	candidates = [
		...
		HERE / "input" / "tmy_24.148_120.703_2005_2023[UTC+8][daily][mapped].csv",
