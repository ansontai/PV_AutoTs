...
model = AutoTS(
    ...
    ensemble=['horizontal_weighted', 'horizontal'],
...
# 已儲存到 T:\OneDrive\1TB\School\SolarRecord\AutoTs7_Superfast.csv
# 預測發電量：
#                             y
# 2026-02-04 00:00:00  0.147616
...
#  ### end. model = AutoTS(forecast_length = 360)