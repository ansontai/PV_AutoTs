...
# DEFAULT_MODEL_LIST = ['SeasonalNaive']
...
DEFAULT_OUTPUT_TAG = 'AverageValueNaive-30Seed'
# DEFAULT_OUTPUT_TAG = 'S1_G30_90d_120d-1Seed'
...
if __name__ == '__main__':
    ...
    script_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '6vB3-autoTs_WeatherToDayWh.py'))
