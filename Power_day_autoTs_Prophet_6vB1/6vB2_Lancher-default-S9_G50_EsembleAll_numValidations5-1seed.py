...
##
# DEFAULT_MODEL_LIST = [
#     'default', # default includes a variety of models; if using default, no need to specify others unless you want to force include/exclude certain models
#     'LastValueNaive',
#     'SeasonalNaive',
#     'UnobservedComponentsu',
#     'VAR',
#     'MultivariateMotif',
#     'FFT',
...
#     'LastValueNaive',
#     'SeasonalNaive',
#     # 'UnobservedComponentsu', # 錯誤，訊息為 Model String 'XGBoost' not a recognized model type。
#     # 'VAR', # 錯誤，訊息為 Model String 'XGBoost' not a recognized model type。 # VAR is very slow and often fails to converge, especially with exogenous variables; recommend only for small datasets and short horizons if at all # 錯誤，訊息為 Model String 'XGBoost' not a recognized model type。
#     # 'MultivariateMotif', # 錯誤，訊息為 Model String 'XGBoost' not a recognized model type。
#     'FFT',
#     'Theta',
#     'ARIMA', # 時間序列模型
#     'RollingRegression',
...
#     # X 'SeasonalNaive',
#     # 機器學習（Random Forest、SVR）
#     # 'XGBoost', #（若環境已安裝）  # 錯誤，訊息為 Model String 'XGBoost' not a recognized model type。
# #     'RandomForest', # 錯誤，訊息為 Model String 'XGBoost' not a recognized model type。
# #     'SVR', # 錯誤，訊息為 Model String 'XGBoost' not a recognized model type。
# #     # 深度學習（LSTM）
# #     'LSTM', # 錯誤，訊息為 Model String 'XGBoost' not a recognized model type。
# #     # 機器學習（ML）模型（最穩定使用 exogenous）這一類對外生變數支援最好、效果最明顯：
# #     'RandomForest', # 錯誤，訊息為 Model String 'XGBoost' not a recognized model type。
#     'pMLP',
# ]

## version_4 # by copilot
# DEFAULT_MODEL_LIST = [
#     'ETS', 'ARIMA', 'Prophet',
#     'RollingRegression', 
#     'VARMAX', 'VECM',
#     'GLS', 'AverageValueNaive', 
#     'LastValueNaive',
#     # 'RandomForest', 
#     # 'XGBoost',
#     # my add
...
DEFAULT_OUTPUT_TAG = 'default-S9_G50_EsembleAll_numValidations5_1seed'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_validations', type=int, default=DEFAULT_NUM_VALIDATIONS,
                        help='AutoTS num_validations forwarded to child script')
    ...
    script_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '6vB2-autoTs_WeatherToDayWh.py'))
