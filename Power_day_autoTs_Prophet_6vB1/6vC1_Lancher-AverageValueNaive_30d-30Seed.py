...
DEFAULT_OUTPUT_TAG = '6vC1_Lancher-AverageValueNaive_30d-30Seed'
...
if __name__ == '__main__':
    ...
    script_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '6vC1-autoTs_WeatherToDayWh.py'))
