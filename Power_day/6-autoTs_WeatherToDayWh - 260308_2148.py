...
def main():
    ...
    for idx, horizon in enumerate(horizons):
        ...
        # Pass metric explicitly to fit so AutoTS optimizes MAE
        try:
            model = model.fit(train_wide, metric='MASE')
        except TypeError:
            # Older/newer AutoTS versions may not accept metric in fit; fall back to default fit
