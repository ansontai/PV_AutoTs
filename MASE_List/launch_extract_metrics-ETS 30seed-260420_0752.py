...
# ETS_S0_EsNone-30Seed
# T:\OneDrive\1TB\School\PV_autoTs\Power_day_autoTs_Prophet_6vD1\output\ETS\ETS_S0_EsNone-30Seed
default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs\Power_day_autoTs_Prophet_6vD1\output\ETS\ETS_S0_EsNone-30Seed"))

# default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/ETS 30seed-260420_0752"))
# default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/ETS 30seed-260420_0752"))

default_output_path = str(Path(__file__).resolve().parent / 'output' / 'ETS' / 'ETS_S0_EsNone-30Seed.csv')
