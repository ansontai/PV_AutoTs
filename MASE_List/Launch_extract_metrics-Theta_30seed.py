...
default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/Theta/Theta_30seed"))
...
default_output_path = str(Path(__file__).resolve().parent / 'output' / 'Theta-30seed-260424_022034' / 'Theta-30seed-260424_022034.csv')
