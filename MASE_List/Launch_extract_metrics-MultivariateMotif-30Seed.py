...
# T:\OneDrive\1TB\School\PV_autoTs\Power_day_autoTs_Prophet_6vB1\output\MultivariateMotif\MultivariateMotif_30seed
default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/MultivariateMotif/MultivariateMotif_30seed"))
...
default_output_path = str(Path(__file__).resolve().parent / 'output' / 'MultivariateMotif-30seed-260424_022034' / 'MultivariateMotif-30seed-260424_022034.csv')
