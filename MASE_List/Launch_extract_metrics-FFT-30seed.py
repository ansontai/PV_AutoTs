...
## FFT-30seed
# T:\OneDrive\1TB\School\PV_autoTs\Power_day_autoTs_Prophet_6vB1\output\FFT-30seed
default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/FFT-30seed"))

## pMLP-30seed-260423_014553-062244
# T:\OneDrive\1TB\School\PV_autoTs\Power_day_autoTs_Prophet_6vB1\output\pMLP-30seed-260423_014553-062244
# default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/pMLP-30seed-260423_014553-062244"))
...
# default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/UnobservedComponents-30Seed_260424_0333"))
...
default_output_path = str(Path(__file__).resolve().parent / 'output' / 'FFT-30seed' / 'FFT-30seed.csv')
