...
## Prophet_27-30seed-90d120d
# T:\OneDrive\1TB\School\PV_autoTs\Power_day_autoTs_Prophet_6vB1\output\Prophet\Prophet_27-30seed-90d120d
default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/Prophet/Prophet_27-30seed-90d120d"))
...
default_output_path = str(Path(__file__).resolve().parent / 'output' / 'Prophet_27-30seed-90d120d' / 'Prophet_27-30seed-90d120d.csv')
