...
## L7_Lancher-S92b_G50_120d_TmyTrue_30Seed-FitFalse
# T:\OneDrive\1TB\School\PV_autoTs\Power_1Year_Sum_10v2A\output\default\L7_Lancher-S92b_G50_120d_TmyTrue_30Seed-FitFalse
default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_1Year_Sum_10v2A/output/default/L7_Lancher-S92b_G50_120d_TmyTrue_30Seed-FitFalse"))
...
# default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_1Year_Sum_10v2A/output/default/L7_Lancher-S92b_G50_120d_TmyTrue_30Seed-FitEn"))
...
default_output_path = str(Path(__file__).resolve().parent / 'output' / sub_folder_name / f'{sub_folder_name}_holdout_mase.csv')
...
def main():
    ...
    parser.add_argument('--pattern', '-p', default='effective_settings_*.csv', help='Glob pattern to search (default effective_settings_*.csv)')
    ...
    argv.append('--append-mase-summary')
    argv.extend(['--holdout-mase-column', 'holdout_mase'])
