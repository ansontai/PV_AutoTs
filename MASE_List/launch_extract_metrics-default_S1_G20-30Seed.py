...
# t:\OneDrive\1TB\School\PV_autoTs\Power_day_autoTs_Prophet_6vB1\output\default\R3\260425_152919\effective_settings.json
# default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/default/R3/"))

# default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/ETS 30seed-260420_0752"))
# default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vB1/output/ETS 30seed-260420_0752"))

## S1_G20-30Seed
# Power_day_autoTs_Prophet_6vD1\output\default\S1_G20-30Seed
default_input_path = str(Path("T:/OneDrive/1TB/School/PV_autoTs/Power_day_autoTs_Prophet_6vD1/output/default/S1_G20-30Seed"))

default_output_path = str(Path(__file__).resolve().parent / 'output' / 'S1_G20-30Seed' / 'S1_G20-30Seed.csv')
